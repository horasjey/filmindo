...
[74, 716], {
    7387: function (t, e, i) {
        ...
        var n = i(2957),
            o = function (t) {
                ...
                var o = 1;
                if (i[0].indexOf(" --> ") > 0 && (o = 0), i.length > o + 1 && i[o + 1]) {
                    var a = i[o],
                        s = a.indexOf(" --> ");
        ...
        var n, o = i(7462),
            ...
            d = function (t) {
                ...
                var x = function () {
                        ...
                        if (t) {
                            var e;
                            if (b.get("fullscreen") && a.OS.iOS) e = null;
                            else {
                                var i = t * f;
                                e = Math.round(10 * function (t) {
                                    ...
                                    if (e && e.videoHeight) {
                                        var i = e.videoWidth,
                                            n = e.videoHeight,
                                            o = i / n,
                                            s = b.get("containerHeight"),
                                            r = b.get("containerWidth");
                                        if (b.get("fullscreen") && a.OS.mobile) {
                                            var l = window.screen;
                                            l.orientation && (s = l.availHeight, r = l.availWidth)
                                        }
                                        if (r && s && i && n) return (r / s > o ? s : n * r / i) * f
                                    }
                                    return t
                                }(i)) / 10
                            }
                            b.get("renderCaptionsNatively") ? function (t, e) {
                                ...
                                e && (e += "px", a.OS.iOS && (0, c.iv)(i, {
                                    fontSize: "inherit"
                                }, t, !0)), m.fontSize = e, (0, c.iv)(i, m, t, !0)
                            }(b.get("id"), e) : (0, c.oB)(y, {
                                fontSize: e
                            })
                        }
                    ...
                    k = function t() {
                        (0, u.xV)(e.fontSize) && (b.get("containerHeight") ? f = w.fontScale * (e.userFontScale || 1) * e.fontSize / w.fontSize : b.once("change:containerHeight", t, v))
                    },
                    C = function (t, e, i) {
                    ...
                    z = function (t, e) {
                        x(),
                            function (t, e) {
                                ...
                                }, t, !0), (0, c.iv)("#" + t + " .jw-video::-webkit-media-text-track-display", m, t, !0), (0, c.iv)("#" + t + " .jw-video::cue", e, t, !0)
                            }(t, e),
                            function (t, e) {
                                (0, c.iv)("#" + t + " .jw-text-track-display", m, t), (0, c.iv)("#" + t + " .jw-text-track-cue", e, t)
                            }(t, e)
                    };
                this.show = function () {
                    (0, p.cn)(y, "jw-captions-enabled")
                }, this.hide = function () {
                    (0, p.IV)(y, "jw-captions-enabled")
                }, this.populate = function (t) {
                    b.get("renderCaptionsNatively") || (d = [], r = t, t ? this.selectCues(t, h) : this.renderCues())
                }, this.resize = function () {
                    x(), this.renderCues(!0)
                }, this.renderCues = function (t) {
                    t = Boolean(t), n && n.processCues(window, d, y, t)
                    ...
                    var i = t.source,
                        n = e.metadata,
                        o = e.currentTime;
                    return i && n && (0, u.hj)(n[i]) && (o = n[i]), o
                }, this.clear = function () {
                    (0, p.cS)(y)
                }, this.setup = function (t, i) {
                    j = document.createElement("div"), g = document.createElement("span"), j.className = "jw-captions-window jw-reset", g.className = "jw-captions-text jw-reset", e = (0, o.Z)({}, w, i), f = w.fontScale;
                    var n = function () {
                        k(e.fontSize);
                        var i = e.windowColor,
                            n = e.windowOpacity,
                        ...
                        ! function (t, e) {
                            var i = e.color,
                                n = e.fontOpacity;
                            if ((i || n !== w.fontOpacity) && (t.color = (0, c.HY)(i || "#ffffff", n)), e.back) {
                        ...
                        }(a, e), (i || n !== w.windowOpacity) && (m.backgroundColor = (0, c.HY)(i || "#000000", n)), C(o, a, e.fontOpacity), e.back || null !== o || C("uniform", a), (0, c.oB)(j, m), (0, c.oB)(g, a), z(t, a)
                    };
                    n(), j.appendChild(g), y.appendChild(j), b.change("captionsTrack", (function (t, e) {
                        this.populate(e)
                    }), this), b.set("captions", e), b.on("change:captions", (function (t, i) {
                        e = i, n()
                    }))
                }, this.element = function () {
                    return y
                }, this.destroy = function () {
                    b.off(null, null, this), this.off()
                };
                var T = function (t) {
                    h = t, v.selectCues(r, h)
                };
                b.on("change:playlistItem", (function () {
                    h = null, d = []
                }), this), b.on(l.NZ, (function (t) {
                    d = [], T(t)
                }), this), b.on(l.R2, T, this), b.on("subtitlesTrackData", (function () {
                    this.selectCues(r, h)
                }), this), b.on("change:captionsList", (function t(e, o) {
            ...
            h = function (t) {
                ...
                if (n || t.icon) {
                    var o = (0, l.Z)("jw-settings-" + e + " jw-submenu-" + e, (function (e) {
                        ...
                        a = o.element();
                    return a.setAttribute("name", e), a.setAttribute("role", "button"), a.setAttribute("type", "button"), a.setAttribute("aria-expanded", "false"), a.setAttribute("aria-controls", t.el.id), "ontouchstart" in window || (o.tooltip = (0, d.m)(a, e, i)), o.ui.directSelect = !0, o
                }
            },
            j = i(8518),
            g = function (t) {
                ...
                return i.createItemsContainer = function () {
                    ...
                    return s.on("keydown", (function (a) {
                        if (event.target.parentNode === e) {
                            var s, l = a.sourceEvent,
                                c = a.target,
                                p = t.topbar && t.topbar.firstChild,
                                u = document.getElementsByClassName("jw-icon-settings")[0],
                                d = o ? (0, r.AH)(o) : i,
                                h = o ? (0, r.i3)(o) : n,
                                j = (0, r.AH)(c) || p || e.firstChild,
                                g = (0, r.i3)(c) || p || e.lastChild,
                                f = l && (0, w.ku)(l.key);
                            switch (f) {
                            case "Tab":
                                s = l.shiftKey ? h : d;
                    ...
                    var o = this;
                    void 0 === i && (i = {}), void 0 === n && (n = p.k);
                    var a = this.name;
                    return t.map((function (t, s) {
                        var l, c, p, u;
                        switch (a) {
                        case "quality":
                            "Auto" === t.label && 0 === s ? (l = "" + i.defaultText, p = ' <span class="jw-reset jw-auto-label"></span>') : l = t.label;
                            break;
                        case "captions":
                            l = "Off" !== t.label && "off" !== t.id || 0 !== s ? t.label : i.defaultText;
                            break;
                        case "playbackRates":
                            c = t, l = (0, j.t6)(i.tooltipText) ? "x" + t : t + "x";
                            break;
                        case "audioTracks":
                            l = t.name
                        }
                        l || (l = t, "object" == typeof t && (l.options = i));
                        return u = new n(l, function (t) {
                            if ((0 !== t.pageX || 0 !== t.pageY) && !u.active) {
                                if (u.deactivate) {
                                ...
                                u.activate && u.activate(), e(c || s)
                            }
                        }.bind(o)), p && u.el.appendChild((0, r.az)(p)), u
                    }))
                    ...
                    if (this.items.length) {
                        var o = t && t.sourceEvent,
                            a = this.itemsContainer ? this.itemsContainer.el.firstChild : this.items[0].el,
                            s = this.itemsContainer ? this.itemsContainer.el.lastChild : this.items[this.items.length - 1].el,
                            r = o && "keydown" === o.type,
                            l = "Up" === (r && (0, w.ku)(o.key)) ? s : a;
                        if (!this.visible || this.openMenus.length) {
                            var c = this.mainMenu,
                                p = this.parentMenu,
                                u = this.categoryButton;
                            if (p.openMenus.push(this.name), p.openMenus.length > 1 && p.closeChildren(this.name), u && u.element().setAttribute("aria-expanded", "true"), p.isSubmenu) {
                                p.el.classList.remove("jw-settings-submenu-active"), c.topbar.el.classList.add("jw-nested-menu-open");
                                var d = c.topbar.el.querySelector(".jw-settings-topbar-text");
                                d.setAttribute("name", this.title), d.innerText = this.title;
                                var h = p.title;
                                this.setBackButtonAriaLabel(h), c.backButton.show(), this.mainMenu.backButtonTarget = this.parentMenu, this.buttonContainer && this.buttonContainer.el.setAttribute("aria-expanded", !0), e = d
                            ...
                            this.el.classList.add("jw-settings-submenu-active"), n && r ? e = l : n || (c.open(t), e = u.element(), u && u.tooltip && !r && (u.tooltip.suppress = !0)), this.openMenus.length && this.closeChildren(), this.el.scrollTop = 0, this.visible = !0, this.el.setAttribute("aria-expanded", "true"), e && (this._openTimeout && clearTimeout(this._openTimeout), this._openTimeout = setTimeout((function () {
                                e.focus(), i._openTimeout = null
                            })))
                        } else this.items.length && r && (this._openTimeout && clearTimeout(this._openTimeout), this._openTimeout = setTimeout((function () {
    ...
    5349: function (t, e, i) {
        ...
        var n = i(2799),
            o = function (t, e, i, o, a) {
                var s = document.createElement("div");
                s.className = "jw-reset-text jw-tooltip jw-tooltip-" + e, s.setAttribute("dir", "auto");
                var r, l = document.createElement("div");
                l.className = "jw-text", s.appendChild(l), t.appendChild(s);
                var c = function (t) {
                    t && r.dirty && ((0, n.nh)(l, r.text), r.dirty = !1), r.opened = t, (0, n.og)(s, "jw-open", t)
                };
                return r = {
                    dirty: Boolean(i),
                    opened: !1,
                    ...
                    close: function () {
                        r.touchEvent || (c(!1), a && a())
                    },
                    setText: function (t) {
                        t !== r.text && (r.text = t, r.dirty = !0), r.opened && c(!0)
                    }
                }, t.addEventListener("mouseover", r.open), t.addEventListener("focus", r.open), t.addEventListener("blur", r.close), t.addEventListener("mouseout", r.close), t.addEventListener("touchstart", (function () {
                    r.touchEvent = !0
                }), {
                    passive: !0
                }), r
    ...
    8993: function (t, e, i) {
        ...
        var n = i(4578),
            ...
            b = function (t) {
                function e(e, i, n) {
                    var a, s, r, l;
                    return (a = t.call(this, "jw-slider-time", "horizontal") || this)._model = e, a._api = i, a.timeUpdateKeeper = n, a.timeTip = new v("jw-tooltip-time", null, !0), a.timeTip.setup(), a.cues = [], a.seekThrottled = (0, o.P2)(a.performSeek, 400), a._updateAriaTextLimitedThrottled = (s = (0, o.P2)(a.updateAriaText, 1e3), r = 4, l = 0, (0, c.Z)((function () {
                        if (++l < r) {
                    ...
                    })), a.sliderOptions = a._model.get("timeSlider"), a
                }(0, n.Z)(e, t);
                var i = e.prototype;
                return i.setup = function () {
                    var e = this;
                    ...
                    var i = this.el;
                    (0, l.P$)(i, "tabindex", "0"), (0, l.P$)(i, "role", "slider"), (0, l.P$)(i, "aria-label", this._model.get("localization").slider), i.removeAttribute("aria-hidden"), this.elementRail.appendChild(this.timeTip.element()), this.ui = (this.ui || new p.ZP(i)).on("move drag", this.showTimeTooltip, this).on("dragEnd out", this.hideTimeTooltip, this).on("click", (function () {
                        return i.focus()
                    })).on("focus", (function () {
                    ...
                    if (0 !== e) {
                        var i, n = this._model.get("containerWidth"),
                            o = (0, l.A8)(this.elementRail),
                            c = t.pageX ? t.pageX - o.left : t.x,
                            p = (c = (0, a.v)(c, 0, o.width)) / o.width,
                            u = e * p;
                        if (e < 0) u = (e += this._model.get("dvrSeekLimit")) - (u = e * p);
                        var w = (0, r.timeFormat)(u, !0),
                            d = this.timeTip,
                            h = this.getActiveCue(u);
                        if (h) d.update(w, h.text), i = h.text.length + w.length;
                        else {
                            var j = w;
                            e < 0 && u > -1 && (j = "Live"), d.update(j), i = j.length
                        }
                        this.textLength !== i && (this.textLength = i, d.resetWidth()), this.showThumbnail(u), (0, l.cn)(d.el, "jw-open");
                        var g = d.getWidth(),
                            f = n - o.width,
                            m = 0;
                        g > f && (m = (g - f) / 2);
                        var v = Math.round(4 * Math.min(o.width - m, Math.max(m, c))) / 4;
                        (0, s.vs)(d.el, "translateX(" + v + "px)")
                    }
                    ...
                    var o = (0, r.timeFormatAria)(i) + " of " + (0, r.timeFormatAria)(n);
                    ...
                    t && (this.vttPath = t.split("?")[0].split("/").slice(0, -1).join("/"), this.individualImage = null, (0, h.h)(t, this.thumbnailsLoaded.bind(this), this.thumbnailsFailed.bind(this), {
                        plainText: !0
                    }))
                }, i.thumbnailsLoaded = function (t) {
                    var e = this,
                        i = (0, j.Z)(t.responseText);
                    Array.isArray(i) && (i.forEach((function (t) {
                        e.thumbnails.push(new m(t))
                    ...
                    if (i.indexOf("#xywh") > 0) try {
                            var o = /(.+)#xywh=(\d+),(\d+),(\d+),(\d+)/.exec(i);
                            if (!o) throw new Error("No match for expected thumbnail pattern");
                            i = o[1];
                            var a = parseFloat(o[2]),
                                r = parseFloat(o[3]);
                            n.backgroundPosition = -1 * a + "px " + -1 * r + "px", n.width = o[4], this.timeTip.setWidth(Number(s.oB.width)), n.height = o[5]
                        } catch (t) {
                            return
                    ...
                    (0, h.h)(t, this.chaptersLoaded.bind(this), this.chaptersFailed, {
                        plainText: !0
                    })
                }, i.chaptersLoaded = function (t) {
                    var e = (0, j.Z)(t.responseText);
                    if (Array.isArray(e)) {
                        ...
                        if (!i.chapters || !i.chapters.timestamps || !i.chapters.timestamps.length) {
                            ...
                            i.chapters = n, this._model.set("playlistItem", i), n.timestamps[0] && 0 === n.timestamps[0].time && this._api.trigger(f.t6, n.timestamps[0])
                        }
                    }
                }, i.chaptersFailed = function () {}, i.addCue = function (t) {
                    var e = new d.M(t.begin, t.text, t.cueType);
                    ...
                    if (e && e.timestamps) {
                        ...
                        i && i !== this.activeChapter && (this.activeChapter = i, this._api.trigger(f.t6, i))
                    }
                }, e
            }(u.Z),
            y = b
    ...
    8268: function (t, e, i) {
        ...
        var n = i(7462),
            ...
            d = function (t) {
                function e(e, i, n) {
                    var o;
                    return (o = t.call(this, e, i, n) || this).cues = [], o.className = "jw-slider-time jw-chapter-slider-time jw-background-color jw-reset", o
                }(0, c.Z)(e, t);
                var i = e.prototype;
                return i.setup = function () {
                        ...
                        o.forEach((function (t, e) {
                            var l = e + 1 === o.length,
                                c = {
                                    ...
                                    first: !1,
                                    last: !1,
                                    ads: n(a, t.begin, t.end),
                                    image: t.image
                                };
                            l && void 0 !== t.end && t.end >= s && (c.last = !0), r || (r = !0, c.first = !0), i.addCue(c)
                        }));
                        var c = o[o.length - 1];
                        if (void 0 !== c.end && c.end < s) {
                            var p = {
                                begin: c.end,
                                end: s,
                                text: "",
                    ...
                    var e = new w(t.begin, t.end, t.text, t.first, t.last, t.ads, t.image);
                    e.makeEl(), this.cues.push(e)
                }, i.getActiveCue = function (t) {
                    ...
                    var i = t.prototype.chooseThumbnail.call(this, e),
                        ...
                        o = !i;
                    return this.sliderOptions && this.sliderOptions.preferChapterImages && (o = !0), o && n && n.image ? n.image : i
                }, e
            }(l.Z),
            h = i(7326),
            j = i(520),
            ...
            m = function (t) {
                function e(e, i, n) {
                    ...
                    return "vertical" === e && (a += " jw-volume-tip"), (o = t.call(this, a, e) || this).setup(), o.element().classList.remove("jw-background-color"), (0, p.P$)(n, "tabindex", "0"), (0, p.P$)(n, "aria-label", i), (0, p.P$)(n, "aria-orientation", e), (0, p.P$)(n, "aria-valuemin", 0), (0, p.P$)(n, "aria-valuemax", 100), (0, p.P$)(n, "role", "slider"), o.uiOver = new f.ZP(n).on("click", (function () {})), o
                }
                return (0, c.Z)(e, t), e
            }(g.Z),
            v = function (t) {
                function e(e, i, n, o, a) {
                    ...
                    return s.horizontalSlider = new m("horizontal", r, a), s.verticalSlider = new m("vertical", r, s.tooltip), a.appendChild(s.horizontalSlider.element()), s.addContent(s.verticalSlider.element()), s.verticalSlider.on("update", (function (t) {
                        this.trigger("update", t)
                    }), (0, h.Z)(s)), s.horizontalSlider.on("update", (function (t) {
                        this.trigger("update", t)
                    }), (0, h.Z)(s)), s.horizontalSlider.uiOver.on("keydown", (function (t) {
                        var e = t.sourceEvent;
                        switch (e.keyCode) {
                        case 37:
                        ...
                        directSelect: !0
                    }).on("click", s.handleClick, (0, h.Z)(s)).on("enter", (function () {
                        return s.trigger("toggleValue")
                    })), s.addSliderHandlers(s.ui), s.addSliderHandlers(s.horizontalSlider.uiOver), s.addSliderHandlers(s.verticalSlider.uiOver), s._model.change("audioMode", s.updateSlider, (0, h.Z)(s)), s
                }(0, c.Z)(e, t);
                var i = e.prototype;
                return i.updateSlider = function (t, e) {
                    var i = t.get("horizontalVolumeSlider") || e;
                    (0, p.og)(this.element(), "jw-flag-horizontal-slider", Boolean(i))
                    ...
                    t.prototype.openTooltip.call(this, e), (0, p.og)(this.horizontalContainer, this.openClass, !0)
                }, i.closeSlider = function (e) {
                    t.prototype.closeTooltip.call(this, e), (0, p.og)(this.horizontalContainer, this.openClass, !1), this.horizontalContainer.blur()
            ...
            S = function (t, e) {
                ...
                return i.className = "jw-icon jw-icon-inline jw-text jw-reset " + t, e && (0, p.P$)(i, "role", e), i
            },
            M = function (t) {
            ...
            B = function (t, e) {
                if ("WebKitPlaybackTargetAvailabilityEvent" in window) {
                    var i = (0, b.Z)("jw-icon-airplay jw-off", t, e.airplay, (0, s.o)("airplay-off,airplay-on"));
                    return (0, y.m)(i.element(), "airplay", e.airplay), i
                }
                if (o.Browser.chrome && window.chrome) {
                    var n = document.createElement("google-cast-launcher");
                    (0, p.P$)(n, "tabindex", "-1"), n.className += " jw-reset";
                    var a = (0, b.Z)("jw-icon-cast", null, e.cast);
                    a.ui.off();
                    var r = a.element();
                    return r.style.cursor = "pointer", r.appendChild(n), a.button = n, (0, y.m)(r, "chromecast", e.cast), a
                }
            },
            E = function (t, e, i) {
                if (!o.OS.mobile && "disabled" !== t && (o.Browser.chrome && !(0, k.yS)() || o.Browser.edge || o.Browser.safari)) {
                    var n = (0, b.Z)("jw-icon-pip jw-off", e, i.pipIcon, (0, s.o)("pip-on,pip-off"));
                    return (0, y.m)(n.element(), "pip", i.pipIcon), n
                }
            },
            A = function (t, e) {
                return t.filter((function (t) {
            ...
            Z = function () {
                function t(t, e, i) {
                    var r = this;
                    (0, n.Z)(this, x.ZP), this._api = t, this._model = e, this._isMobile = o.OS.mobile, this._volumeAnnouncer = i.querySelector(".jw-volume-update");
                    var c = e.get("localization"),
                        u = e.get("timeSlider"),
                        w = new(!u || u.legacy ? l.Z : d)(e, t, i.querySelector(".jw-time-update"));
                    w.setup();
                    var h, j, g, m = this.menus = [];
                    this.ui = [];
                    var k = "",
                        C = c.volume;
                    if (this._isMobile) {
                        if (!(e.get("sdkplatform") || o.OS.iOS && o.OS.version.major < 10)) {
                            ...
                            g = (0, b.Z)("jw-icon-volume", (function () {
                                t.setMute()
                            }), C, A)
                        }
                    } else {
                        (j = document.createElement("div")).className = "jw-horizontal-volume-container";
                        var Z = (h = new v(e, "jw-icon-volume", C, (0, s.o)("volume-0,volume-50,volume-100"), j)).element();
                        m.push(h), (0, p.P$)(Z, "role", "group"), e.change("mute", (function (t, e) {
                            var i = e ? c.unmute : c.mute;
                            (0, p.P$)(Z, "aria-label", i + " button")
                        }), this)
                    }
                    var I = (0, b.Z)("jw-icon-next", (function () {
                            t.next({
                                feedShownId: k,
                                reason: "interaction"
                            })
                        }), c.next, (0, s.o)("next")),
                        H = (0, b.Z)("jw-icon-settings jw-settings-submenu-button", (function (t) {
                            r.trigger("settingsInteraction", "quality", !0, t)
                        }), c.settings, (0, s.o)("settings"));
                    (0, p.P$)(H.element(), "aria-controls", "jw-settings-menu"), (0, p.P$)(H.element(), "aria-expanded", !1);
                    var P = (0, b.Z)("jw-icon-cc jw-settings-submenu-button", (function (t) {
                        r.trigger("settingsInteraction", "captions", !1, t)
                    }), c.cc, (0, s.o)("cc-off,cc-on"));
                    (0, p.P$)(P.element(), "aria-controls", "jw-settings-submenu-captions");
                    var V = (0, b.Z)("jw-text-live", (function () {
                        r.goToLiveEdge()
                    }), c.liveBroadcast);
                    V.element().textContent = c.liveBroadcast;
                    var _, O, N, R = this.elements = {
                            alt: (_ = "jw-text-alt", O = "status", N = document.createElement("span"), N.className = "jw-text jw-reset-text " + _, O && (0, p.P$)(N, "role", O), (0, p.P$)(N, "dir", "auto"), N),
                            play: (0, b.Z)("jw-icon-playback", (function () {
                                t.playToggle({
                                    reason: "interaction"
                                })
                            }), c.play, (0, s.o)("play,pause,stop")),
                            rewind: (0, b.Z)("jw-icon-rewind", (function () {
                                r.rewind()
                            }), c.rewind, (0, s.o)("rewind")),
                            live: V,
                            next: I,
                            elapsed: S("jw-text-elapsed", "timer"),
                            countdown: S("jw-text-countdown", "timer"),
                            time: w,
                            duration: S("jw-text-duration", "timer"),
                            mute: g,
                            volumetooltip: h,
                            ...
                            pip: E(e.get("pipIcon"), (function () {
                                t.setPip()
                            }), c),
                            imaFullscreen: (0, b.Z)("jw-icon-fullscreen", (function () {
                                t.setFullscreen()
                            }), c.fullscreen, (0, s.o)("fullscreen-off,fullscreen-on")),
                            fullscreen: (0, b.Z)("jw-icon-fullscreen", (function () {
                                t.setFullscreen()
                            }), c.fullscreen, (0, s.o)("fullscreen-off,fullscreen-on")),
                            spacer: M("jw-spacer"),
                        ...
                        q = (0, y.m)(P.element(), "captions", c.cc),
                        U = function (t) {
                            var e = t.get("captionsList")[t.get("captionsIndex")],
                                i = c.cc;
                            e && "Off" !== e.label && (i = e.label), q.setText(i)
                        },
                        F = (0, y.m)(R.play.element(), "play", c.play);
                    this.setPlayText = function (t) {
                        F.setText(t)
                    };
                    var D = R.next.element(),
                        W = (0, y.m)(D, "next", c.nextUp, (function () {
                            var t = e.get("nextUp");
                            t && (k = (0, z.B)(z.F), r.trigger("nextShown", {
                                mode: t.mode,
                                ui: "nextup",
                                itemsShown: [t],
                                feedData: t.feedData,
                    ...
                    (0, p.P$)(D, "dir", "auto"), (0, y.m)(R.rewind.element(), "rewind", c.rewind), (0, y.m)(R.settingsButton.element(), "settings", c.settings);
                    var $ = [(0, y.m)(R.fullscreen.element(), "fullscreen", c.fullscreen), (0, y.m)(R.imaFullscreen.element())];
                    (0, p.cn)(R.imaFullscreen.element(), "jw-fullscreen-ima");
                    var K = [R.play, R.rewind, R.next, R.volumetooltip, R.horizontalVolumeContainer, R.imaFullscreen, R.mute, R.alt, R.live, R.elapsed, R.countdown, R.duration, R.spacer, R.cast, R.captionsButton, R.settingsButton, R.pip, R.fullscreen].filter((function (t) {
                            return t
                        })),
                        Y = [R.time, R.buttonContainer].filter((function (t) {
                            return t
                        }));
                    this.el = document.createElement("div"), this.el.className = "jw-controlbar jw-reset", L(R.buttonContainer, K), L(this.el, Y);
                    var X = e.get("logo");
                    if (X && "control-bar" === X.position && this.addLogo(X), R.play.show(), R.fullscreen.show(), R.imaFullscreen.show(), R.mute && R.mute.show(), R.pip && R.pip.show(), e.change("volume", this.onVolume, this), e.change("mute", (function (t, e) {
                            ...
                            for (var i = [r.elements.fullscreen.element(), r.elements.imaFullscreen.element()], n = 0; n < i.length; n++) {
                                var o = i[n];
                                (0, p.og)(i[n], "jw-off", e);
                                var a = t.get("fullscreen") ? c.exitFullscreen : c.fullscreen;
                                $[n].setText(a), (0, p.P$)(o, "aria-label", a)
                            }
                        }), this), e.change("allowFullscreen", this.onAllowFullscreenToggle, this), e.change("pip", (function (t, e) {
                            r.elements.pip && (0, p.og)(r.elements.pip.element(), "jw-off", e)
                            ...
                            var i = c.liveBroadcast,
                                ...
                                a = !1 === e;
                            (0, p.og)(o, "jw-dvr-live", a), (0, p.P$)(o, "aria-label", a ? n : i), o.textContent = a ? n : i
                        }), this), e.change("altText", this.setAltText, this), e.change("customButtons", this.updateButtons, this), e.on("change:captionsIndex", U, this), e.on("change:captionsList", U, this), e.change("nextUp", (function (t, e) {
                            k = (0, z.B)(z.F);
                            var i = c.nextUp;
                            e && e.title && (i += ": " + e.title), W.setText(i), R.next.toggle(Boolean(e))
                        ...
                        var G = R.cast.ui.on("click enter", (function (t) {
                            "keydown" === t.type && R.cast.button.click(), this._model.set("castClicked", !0)
                        }), this);
                        this.ui.push(G)
                    }
                    var J = (0, T.Z)(R.duration, (function () {
                    ...
                    this.ui.push(J);
                    var Q = new f.ZP(this.el).on("click drag", (function () {
                        this.trigger(a.xf)
                    }), this);
                    this.ui.push(Q), m.forEach((function (t) {
                ...
                return e.onVolume = function (t, e) {
                    ...
                    if (i && ((0, p.og)(i.element(), "jw-off", t), (0, p.og)(i.element(), "jw-full", !t)), n) {
                        var o = t ? 0 : e,
                            a = n.element();
                        n.verticalSlider.render(o), n.horizontalSlider.render(o);
                        var s = n.tooltip,
                            r = n.horizontalContainer;
                        (0, p.og)(a, "jw-off", t), (0, p.og)(a, "jw-full", e >= 75 && !t), (0, p.P$)(s, "aria-valuenow", o), (0, p.P$)(r, "aria-valuenow", o);
                        var l = "Volume " + o + "%";
                        (0, p.P$)(s, "aria-valuetext", l), (0, p.P$)(r, "aria-valuetext", l), document.activeElement !== s && document.activeElement !== r && (this._volumeAnnouncer.textContent = l)
                    }
                }, e.onCastAvailable = function (t, e) {
                    this.elements.cast.toggle(e)
                }, e.onCastActive = function (t, e) {
                    this.elements.fullscreen.toggle(!e), this.elements.imaFullscreen.toggle(!e), this.elements.pip && this.elements.pip.toggle(!e), this.elements.cast.button && (0, p.og)(this.elements.cast.button, "jw-off", !e)
                }, e.onElapsed = function (t, e) {
                    var i, n, o = t.get("duration");
                    if ("DVR" === t.get("streamType")) {
                        var a = Math.ceil(e),
                            s = this._model.get("dvrSeekLimit");
                        i = n = a >= -s ? "" : "-" + (0, C.timeFormat)(-(e + s)), t.set("dvrLive", a >= -s)
                    } else i = (0, C.timeFormat)(e), n = (0, C.timeFormat)(o - e);
                    this.elements.elapsed.textContent = i, this.elements.countdown.textContent = n
                }, e.onDuration = function (t, e) {
                    this.elements.duration.textContent = (0, C.timeFormat)(Math.abs(e))
                }, e.onAudioMode = function (t, e) {
                    var i = this.elements.time.element();
                    e ? this.elements.buttonContainer.insertBefore(i, this.elements.elapsed) : (0, p.SH)(this.el, i)
                }, e.element = function () {
                    return this.el
                    ...
                    var i = t.get("localization"),
                        n = i.play;
                    this.setPlayText(n), e === a.r0 && ("LIVE" !== t.get("streamType") ? (n = i.pause, this.setPlayText(n)) : (n = i.stop, this.setPlayText(n))), (0, p.P$)(this.elements.play.element(), "aria-label", n)
                    ...
                    [this.elements.fullscreen.element(), this.elements.imaFullscreen.element()].forEach((function (t) {
                        (0, p.og)(t, "jw-fullscreen-disallowed", !e)
                    }))
                }, e.onStreamTypeChange = function (t, e) {
                    var i = "LIVE" === e,
                        n = "DVR" === e;
                    this.elements.rewind && this.elements.rewind.toggle(!i), this.elements.live.toggle(i || n), (0, p.P$)(this.elements.live.element(), "tabindex", i ? "-1" : "0"), this.elements.duration.style.display = n ? "none" : "", this.onDuration(t, t.get("duration")), this.onState(t, t.get("state"))
                }, e.addLogo = function (t) {
                    var e = this.elements.buttonContainer,
                        i = new r.Z(t.file, this._model.get("localization").logo, (function () {
                            t.link && (0, p.nG)(t.link, "_blank", {
                                rel: "noreferrer"
                            })
                        }), "logo", "jw-logo-button");
                    t.link || (0, p.P$)(i.element(), "tabindex", "-1"), e.insertBefore(i.element(), e.querySelector(".jw-spacer").nextSibling)
                    ...
                    if (e) {
                        ...
                        e !== i && i ? (n = A(e, i), o = A(i, e), this.removeButtons(a, o)) : n = e;
                        for (var s = n.length - 1; s >= 0; s--) {
                            var l = n[s],
                                c = new r.Z(l.img, l.tooltip, l.callback, l.id, l.btnClass);
                            l.tooltip && (0, y.m)(c.element(), l.id, l.tooltip);
                            var p = void 0;
                            "related" === c.id ? p = this.elements.settingsButton.element() : "share" === c.id ? p = a.querySelector('[button="related"]') || this.elements.settingsButton.element() : (p = this.elements.spacer.nextSibling) && "logo" === p.getAttribute("button") && (p = p.nextSibling), a.insertBefore(c.element(), p)
                        }
                    }
            ...
            d = function () {
                function t(t, e) {
                    ...
                    var o = this.el.querySelector(".jw-display-controls"),
                        s = {};
                    w("rewind", (0, u.o)("rewind"), a, o, s, t, e), w("display", (0, u.o)("play,pause,buffer,replay"), c, o, s, t, e), w("next", (0, u.o)("next"), p, o, s, t, e), this.container = o, this.buttons = s
                }
                var e = t.prototype;
                return e.element = function () {
                    return this.el
    ...
    7191: function (t, e, i) {
        ...
        var n = i(147),
            ...
            st = null,
            rt = function () {
                return st || (st = (0, at.Z)("<xml>" + o() + s() + l() + p() + w() + h() + g() + m() + b() + x() + C() + T() + M() + E() + L() + I() + P() + _() + N() + q() + F() + X() + J() + W() + K() + tt() + it() + ot() + "</xml>")), st
            },
            lt = function (t) {
            ...
            pt = function (t) {
                var e = rt().querySelector(lt(t));
                return e ? ct(e) : null
            },
            ut = function (t) {
                var e = rt().querySelectorAll(t.split(",").map(lt).join(","));
    ...
    3112: function (t, e, i) {
        ...
        var n = i(3144),
            ...
            b = function (t) {
                function e(e, i, n) {
                    ...
                    var c = o.elements,
                        w = o.elements = {
                            ...
                            back: (0, p.Z)("jw-icon-back", (function () {
                                o.trigger("backClick")
                    ...
                    w.play.element().removeChild(w.play.element().querySelector(".jw-tooltip-play")), g((0, u.m)(w.settingsButton.element(), "settings", a.settings)), g((0, u.m)(w.back.element(), "back", "Back")), o.topLayout = [w.back, w.settingsButton], o.bottomLayout = [w.play, w.alt, w.live, w.elapsed, w.time, w.countdown];
                ...
                return i.handleKeydown = function (t, e, i) {
                    ...
                    case 39:
                        ...
                        n && this.setActiveButton(n);
                        break;
                    case 38:
                        if (!e) return void this.setActiveButton(this.elements.play);
                        if (i) return;
                        r && (f(this.elements.settingsButton) ? this.setActiveButton(this.elements.settingsButton) : this.setActiveButton(this.elements.back));
                        break;
                    case 40:
                        if (!e) return void this.setActiveButton(this.elements.play);
                        if (i) return;
                        s && this.setActiveButton(this.elements.play);
                        break;
                    case 13:
                    ...
                    if (e)
                        for (var n = this.elements.buttonContainer, o = e.length - 1; o >= 0; o--) {
                            ...
                            a.tooltip && (0, u.m)(s.element(), a.id, a.tooltip), n.appendChild(s.element())
                        }
            ...
            L = function (t) {
                function e(e, i, n, o) {
                    var a;
                    return (a = t.call(this, "settings", o.settings, null, o, A.E6) || this).onInteraction = a.onInteraction.bind((0, T.Z)(a)), a.onTransition = a.onTransition.bind((0, T.Z)(a)), a.ui = new E.ZP(a.el), a.api = e, a.model = i, a.controlbar = n, a.localization = o, a.visible = !1, a.addEventListeners(), a
                }(0, o.Z)(e, t);
                var i = e.prototype;
                return i.addEventListeners = function () {
                    ...
                    if (!i || i.length <= 1) this.removeMenu(t);
                        ...
                        if (!s) {
                            (s = new S.Z(t, e, null, this.localization, A.Z2)).parentMenu = this, s.itemsContainer = new E.ZP(s.el.querySelector(".jw-settings-submenu-items"));
        ...
        var I = function (t, e, i) {
            ...
            H = function (t) {
                ...
                return i.enable = function (e, i) {
                    var n = this;
                    t.prototype.enable.call(this, e, i), (0, w.cn)(this.playerContainer, "jw-tizen-app jw-flag-fullscreen"), this.api = e, this.model = i;
                    ...
                    var r = new z.Z(i, e);
                    I(this.context, r, "jw-tizen-buffer-draw"), I(this.context, r, "jw-tizen-buffer-erase"), o.appendChild(r.element()), this.displayContainer && this.displayContainer.destroy(), this.displayContainer = r;
                    ...
                    var c = this.controlbar;
                    if (c) {
                        var p = c.nextUpToolTip;
                        p && (p.off("all"), i.get("nextUp") && p.onNextUp(i, i.get("nextUp")), c.nextUpToolTip = null, l.nextUpToolTip = p, o.appendChild(p.element())), c.destroy()
                    }
                    this.controlbar = l;
                    var u = this.seekbar = new C(i, e, l.elements.time);
                    o.appendChild(u.element());
                    var d = i.get("localization"),
                        h = new L(e, i.player, this.controlbar, d);
                    h.on(B.xf, (function () {
                        return n.userActive()
                    })), l.on("settingsInteraction", (function () {
                        h.toggle();
                        var t = n.div && n.div.querySelector(".jw-active");
                        h.visible && t && (0, w.IV)(t, "jw-active")
                    })), o.insertBefore(h.el, l.element()), this.settingsMenu && this.settingsMenu.destroy(), this.settingsMenu = h, this.div = o, e.on("playlistComplete", this.onBackClick, this), this.keydownCallback && (this.playerContainer.removeEventListener("keydown", this.keydownCallback), this.keydownCallback = null), this.keydownCallback = function (t) {
                        return n.handleKeydown(t)
                    }, document.addEventListener("keydown", this.keydownCallback), this.addBackdrop(), this.addControls(), this.playerContainer.focus({
                        preventScroll: !0
            ...
            s = function () {
                ...
                return e.hide = function () {
                    ...
                    var e = {},
                        i = t.get("logo");
                    if (i) {
                        var o = 1 * parseInt(("" + i.margin).replace("px", ""), 10),
    ...
    4646: function (t, e, i) {
        ...
        var o = i(4578),
                    ...
                    n = (void 0 === i ? [] : i).map((function (t) {
                        return function (t, e) {
                            var i = t.featured,
                                n = t.showLogo,
                                o = t.type;
                            return t.logo = n ? '<span class="jw-rightclick-logo jw-reset"></span>' : "", '<li class="jw-reset jw-rightclick-item ' + (i ? "jw-featured" : "") + '">' + k[o](t, e) + "</li>"
                        }(t, e)
                    }));
            ...
            E = function () {
                ...
                return e.buildArray = function () {
                    ...
                    var t = this,
                        e = C(this.buildArray(), this.model.get("localization"));
                    if (this.el) {
                        if (this.html !== e) {
                            this.html = e;
                            var i = B(e);
                    ...
                    } else this.html = e, this.el = B(this.html), this.wrapperElement.appendChild(this.el), this.hideMenuHandler = function (e) {
            ...
            N = function (t) {
                function e(e, i, n, o) {
                    ...
                    return (a = t.call(this, "settings", o.settings, null, o) || this).api = e, a.model = i, a.localization = o, a.controlbar = n, a.closeButton = function (t, e, i) {
                        var n = (0, u.Z)("jw-settings-close", e, i.close, [(0, f.W)("close")]);
                        return n.show(), n.ui.on("keydown", (function (t) {
                            var i = t.sourceEvent,
                                n = (0, V.ku)(i.key);
                            ("Enter" === n || "Right" === n || "Tab" === n && !i.shiftKey) && e(t)
                        }), void 0), t.appendChild(n.element()), n
                    }(a.el.querySelector(".jw-" + a.name + "-topbar-buttons"), a.close, o), a.backButtonTarget = null, a.defaultChild = null, a.topbar = (s = (0, L.Z)(a), r = s.closeButton, l = s.el.querySelector(".jw-settings-topbar"), new g.ZP(l).on("keydown", (function (t) {
                        var e, i, n = t.sourceEvent,
                            o = t.target,
                            a = (0, c.AH)(o),
                            l = (0, c.i3)(o),
                            p = function (e) {
                                l ? e || l.focus() : s.close(t)
                            };
                        switch ((0, V.ku)(n.key)) {
                        case "Esc":
                            s.close(t);
                        ...
                        case "Down":
                        case "Enter":
                            e = o.getAttribute("name"), !(i = s.children[e]) && e && s.backButtonTarget && (i = s.backButtonTarget.children[e]), i && i.open && i.open(t)
                        }
                        if (n.stopPropagation(), /13|32|37|38|39|40/.test(n.keyCode)) return n.preventDefault(), !1
                    }))), a.onDocumentClick = a.onDocumentClick.bind((0, L.Z)(a)), a.addEventListeners(), a
                }(0, o.Z)(e, t);
                var i = e.prototype;
                return i.setupMenu = function (t, e, i, n, o, a) {
                    if (!i || i.length <= 1) this.removeMenu(t);
                        ...
                        var s = this.children[t];
                        s || (s = new Z.Z(t, e, this, this.localization)), s.setMenuItems(s.createItems(i, n, a), o);
                    ...
                    n && i && O(t.get("levels"), n.level, i, e), i.items[e].active || (0, V.dt)(i, e)
                }, i.onVisualQuality = function (t, e) {
                    var i = this.children.quality;
                    e && i && O(t.get("levels"), e.level, i, t.get("currentLevel"))
                }, i.onAudioTracks = function (t, e) {
                    var i = this;
                    this.setupMenu("audioTracks", this.localization.audioTracks, e, (function (t) {
                        return i.api.setCurrentAudioTrack(t)
                    ...
                    if (a && !a.children.captionsSettings) {
                        ...
                        var s = this.localization.captionsStyles,
                            r = new Z.Z("captionsSettings", s.subtitleSettings, a, this.localization),
                            l = r.open;
                        r.open = function (t) {
                            var e = r.visible;
                        ...
                        r.destroy = function (t) {
                            a.topbar.parentNode.removeChild(a.topbar), a.topbar = null, a.topbarUI.destroy(), p.call(r, t)
                        };
                        var u = new I.s(this.localization.settings, r.open);
                        a.topbar.appendChild(u.el);
                        var w = t.get("captions");
                        ! function e(n) {
                            var o = new I.s(i.localization.reset, (function () {
                                i.model.set("captions", (0, h.Z)({}, P.R)), e(!0)
                            }));
                            ...
                            (0, V.JU)(s).forEach((function (e) {
                                ...
                                var s = new Z.Z(e.name, e.label, r, i.localization),
                                    l = new I.s(e, s.open, H.v2);
                                s.buttonContainer = l;
                    ...
                    var i = this.children.captions;
                    i && (0, V.dt)(i, e), this.controlbar.toggleCaptionsButtonState(Boolean(e))
                    ...
                    var e = (0, _.i)(this.model.get("containerWidth"));
                    if (!this.visible) {
                    ...
                    var e, i = (0, V.ku)(t && t.sourceEvent && t.sourceEvent.key),
                        ...
                        o = (0, _.i)(this.model.get("containerWidth"));
                    ...
                    if (a) {
                        ...
                        for (var r = Object.keys(this.children), l = 0; l < r.length; l++) {
                            var c = this.children[r[l]],
                                p = c.categoryButton && c.categoryButton.element();
                            this.buttonContainer.firstChild === p && (this.defaultChild = c)
                        }
                }, i.destroy = function () {
        ...
        function U(t, e, i, n) {
            var o, a = !1,
                ...
                p = function () {
                    (0, c.IV)(r, "jw-open"), document.removeEventListener("click", o), a = !1, n(!1)
                };
            o = function (t) {
                var e = t.target;
            ...
            var w, d = function () {
                    l.el.setAttribute("aria-checked", i.get("enableShortcuts")), (0, c.cn)(r, "jw-open"), r.querySelector(".jw-shortcuts-close").focus(), document.addEventListener("click", o), a = !0, n(!0)
                },
                h = function (t) {
            ...
            return w = (0, u.Z)("jw-shortcuts-close", p, i.get("localization").close, [(0, f.W)("close")]), (0, c.SH)(r, w.element()), w.show(), t.appendChild(r), l.on("click", h), {
                el: r,
                open: d,
                close: p,
                destroy: function () {
        ...
        i(9725), i(1334);
        var D = a.OS.mobile ? 4e3 : 2e3,
            W = [27];
        R.Z.cloneIcon = f.W, q.Z.forEach((function (t) {
            if (t.getState() === s.Vy) {
        ...
        var $ = function (t) {
                ...
                return i.resetActiveTimeout = function () {
                    ...
                    if (this.focusPlayerElement = function () {
                        ...
                        var p = new d.Z(e, t);
                        p.buttons.display.on("click enter", (function () {
                            i.trigger(s.cy), i.userActive(1e3), t.playToggle({
                                reason: "interaction"
                            }), i.focusPlayerElement()
                        })), this.div.appendChild(p.element()), this.displayContainer = p
                    }
                    ...
                    if (h.on("adjustVolume", j, this), e.get("nextUpDisplay") && !h.nextUpToolTip) {
                    ...
                    var m = e.get("localization"),
                        v = this.settingsMenu = new N(t, e.player, this.controlbar, m),
                        b = null;
                    v.on("menuVisibility", (function (n) {
                        var o = n.visible,
                            ...
                            p = "keydown" === (a && a.sourceEvent || a || {}).type,
                            u = o || p ? 0 : D;
                        i.userActive(u), (0, _.i)(e.get("containerWidth")) < 2 && (o && r === s.r0 ? t.pause(l) : o || r !== s._5 || b !== s.r0 || t.play(l)), b = r, !o && p && c ? c.element().focus() : a && i.focusPlayerElement()
                    ...
                    })), a.OS.mobile ? this.div.appendChild(v.el) : (this.playerContainer.setAttribute("aria-describedby", "jw-shortcuts-tooltip-explanation"), this.div.insertBefore(v.el, h.element()));
                    var y = function (e) {
                    ...
                    var z = function (t) {
                        switch (t.keyCode) {
                        case 9:
                            var e = i.playerContainer.contains(t.target) ? 0 : D;
                            i.userActive(e);
                            break;
                        case 32:
                            t.preventDefault()
                    ...
                    void 0 === t && (t = D), t > 0 ? (this.inactiveTime = (0, p.z)() + t, -1 === this.activeTimeout && (this.activeTimeout = setTimeout(this.userInactiveTimeout, t))) : this.resetActiveTimeout(), this.showing || ((0, c.IV)(this.playerContainer, "jw-flag-user-inactive"), this.showing = !0, this.trigger("userActive"))
                    ...
                    var i = this,
                        ...
                        l = new F(this.wrapperElement, n.close, r());
            ...
            zt = function (t, e, o, a, s) {
                ...
                ! function () {
                    if (Array.isArray(e.sites)) {
                        var i = [];
                        (0, kt.S6)(e.sites, (function (t) {
                            (0, kt.HD)(t) && n[t] ? i.push(n[t]) : (0, kt.Kn)(t) && i.push(t)
                        })), d = i
                    }
                    t.addButton(xt(), a, j, "share", "jw-settings-sharing");
                ...
                var g = function (t, e) {
                    ...
                    m = function () {
                        var i = t.getPlaylistItem(),
                            ...
                            o = i.mediaid,
                            a = i.link;
                        u = f(o, a), n ? -1 === n.src.indexOf(u) && (n.src = u) : d.push((0, h.Z)({
                            src: u
                        }, vt));
                ...
                return this.getShareMethods = function () {
                    ...
                    void 0 === e && (e = "interaction"), t && !Ct && (Ct = !0, i(3484)), l.trigger(t ? "open" : "close", {
                        visible: t,
                        method: e
                    })
                    ...
                    "embed" !== i && "link" !== i ? function (e) {
                        ...
                        if ((0, kt.mf)(i)) i(u);
                            ...
                            var n = encodeURIComponent(u || "share"),
        ...
        var Bt = Mt,
            ...
            At = function (t) {
                function e(e, i, n) {
                    var o;
                    return void 0 === n && (n = Et), (o = t.call(this, e, i, n) || this).content = e, o.el && e.label ? (o.el.setAttribute("aria-label", e.label), o.el.setAttribute("role", "button"), o.el.setAttribute("tabindex", "0"), o) : (0, L.Z)(o)
                }(0, o.Z)(e, t);
                var i = e.prototype;
                return i.activate = function () {
            ...
            Zt = function (t) {
                ...
                return i.createCategoryButton = function () {
                    return "sharing" === this.name && (this.icon = xt()), t.prototype.createCategoryButton.call(this, this.title)
                }, i.createItems = function (e, i, n, o) {
                    return "sharing" === this.name && (o = Lt), t.prototype.createItems.apply(this, [e, i, n, o])
                }, e
            }(Z.Z),
            It = function (t) {
                function e(e, i) {
                ...
                return i.disable = function (e) {
                    ...
                    t.prototype.enable.call(this, e, i), i.change("instream", (function () {
                        ...
                        n._destroySkipButton(), i && (n.skipButton = new St(t, n.div), n.skipButton.on(s.k3, (function () {
                            t.set("skipButton", !1), e.skipAd()
                        })), n.controlbar.adSkipButton = n.skipButton)
                    }));
                    var o = i.get("localization"),
                        a = i.get("advertising");
                    a && a.outstream && a.dismissible && (this.dismissButton = new Bt(e, this.playerContainer, this.playerContainer.querySelector(".jw-top")), this.dismissButton.setup(o.close));
                    var r = i.get("sharing");
                    if (!this.sharing && r) {
                        var l = this.controlbar,
                            c = this.settingsMenu,
                            p = o.sharing;
                        this.sharing = new zt(e, r, l, p.heading), e.addPlugin("sharing", this.sharing), i.change("playlistItem", (function () {
                            var t = n.sharing.getShareMethods().map((function (t) {
                                var e = p[t.label];
                                return e && (t.displayText = e), t
                            }));
                            c.removeMenu("sharing");
                            var e = new Zt("sharing", o.sharing.heading, c, o),
                                i = e.open,
                                a = e.close,
                                s = o.sharing.copied;
                            e.open = function (t) {
        ...
        t.exports = function (t) {
            ...
            return e.toString = function () {
                ...
                for (var c = 0; c < t.length; c++) {
                    var p = [].concat(t[c]);
                    n && s[p[0]] || (void 0 !== a && (void 0 === p[5] || (p[1] = "@layer".concat(p[5].length > 0 ? " ".concat(p[5]) : "", " {").concat(p[1], "}")), p[5] = a), i && (p[2] ? (p[1] = "@media ".concat(p[2], " {").concat(p[1], "}"), p[2] = i) : p[2] = i), o && (p[4] ? (p[1] = "@supports (".concat(p[4], ") {").concat(p[1], "}"), p[4] = o) : p[4] = "".concat(o)), e.push(p))
                }
            }, e
        }
    },
    ...
    9725: function (t, e, i) {
        ...
        var n = i(3379),
            ...
            j = i(4542),
            g = {};
        g.styleTagTransform = h(), g.setAttributes = p(), g.insert = l().bind(null, "head"), g.domAPI = s(), g.insertStyleElement = w();
        o()(j.Z, g);
